...
class Card(models.Model):
    ...
    end_activity_date = models.DateTimeField(default=get_default_end_activity_date, verbose_name='Дата окончания активности')
    use_date = models.DateTimeField(auto_now=True, verbose_name='Дата использования')
    total = models.DecimalField(default=0.00, max_digits=12, decimal_places=2, verbose_name='Сумма')
    status = models.CharField(max_length=15, choices=STATUS_CHOICES, default='not_activated', verbose_name='Статус карты')
